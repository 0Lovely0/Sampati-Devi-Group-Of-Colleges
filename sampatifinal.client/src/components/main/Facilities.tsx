  ...
  return (
    <section className="bg-indigo-950 py-20 text-white">
      <div className="w-full mx-auto">
        ...
        {/* Heading */}
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-center">Our Facilities</h1>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2">
              {filteredFacilities.map((item) => (
                <div key={item.facilityId} className="group">
                  ...
                  {/* Title */}
                  <p className="text-xs mt-2 text-slate-200 text-center">
