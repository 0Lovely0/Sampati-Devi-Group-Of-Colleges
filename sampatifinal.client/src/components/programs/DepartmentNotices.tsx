...
// import PharmacyNotices from "../../departments/pharmacy/pages/Notices";
// import VeterinaryNotices from "../../departments/veterinary-pharmacist/pages/Notices";
// import PostBasicNotices from "../../departments/post-basic-bsc-nursing/pages/Notices";
// import MphwNotices from "../../departments/multipurpose-health-worker/pages/Notices";
