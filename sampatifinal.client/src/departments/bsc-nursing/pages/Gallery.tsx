      ...
      <div className="w-full mx-auto px-4 -mt-10">
        {loading ? (
          <div className="h-64 flex items-center justify-center">
            <Loader text="Loading B.Sc Nursing Gallery..." />
          </div>
          ...
          <div className="bg-white rounded-3xl p-10 text-center shadow-lg">
            ...
            <p className="text-slate-500 mt-2">
              No B.Sc Nursing gallery images are currently available.
            </p>
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {galleryItems.map((item) => (
              <div
                ...
                className="group relative aspect-square overflow-hidden rounded-3xl bg-white border border-teal-100 shadow-sm cursor-pointer transition-all duration-300 hover:-translate-y-2 hover:shadow-xl"
              >
                <img
