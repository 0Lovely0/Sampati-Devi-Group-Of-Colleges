...
const NoticeBoard: React.FC = () => {
  ...
  useEffect(() => {
    const fetchNotices = async () => {
      try {
        ...
        console.error("MPHW notice fetch failed:", err);
      } finally {
        setLoading(false);
      }
    };
  ...
  const scrollingNotices = notices.length
    ? [...notices, ...notices]
    : [];
      ...
      <div className="w-full mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            >
              ...
              <div>
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-[12px] uppercase tracking-widest text-orange-100 font-bold">
                      Multipurpose Health Worker Department
                    </p>
                  </div>
                </div>

                <div className="flex items-center gap-2 text-orange-100 font-bold text-lg uppercase tracking-widest mb-6">
                  <Sparkles size={14} />
                  Real-time Updates
                </div>

                <p className="text-orange-50 text-lg leading-relaxed">
                  Access all academic circulars, training schedules,
                  examination updates, fieldwork notices, community health
                  program information, and official announcements for the
                  Multipurpose Health Worker Department.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="rounded-2xl bg-white/10 p-4 text-center border border-white/10">
                  ...
                  <p className="text-[12px] uppercase tracking-widest text-orange-100 mt-1">
                    Active
                  </p>
                </div>
          ...
          <div className="lg:col-span-8">
            <div
              className="h-[500px] bg-white p-6 sm:p-8 rounded-3xl border shadow-sm flex flex-col"
              style={{
            ...
            >
              ...
              {loading ? (
                <div className="flex-1 flex items-center justify-center">
                  <Loader text="Loading MPHW notices..." />
                </div>
              ) : notices.length === 0 ? (
                <div className="flex-1 flex items-center justify-center">
                  <p
                  ...
                  <div className="animate-[scrollTop_20s_linear_infinite] space-y-4">
                    {scrollingNotices.map((notice, index) => (
                      <div
                        ...
                        className="flex items-center gap-4 p-4 rounded-xl border border-stone-100 transition-all duration-300"
                        style={{
                          borderColor: "#FED7AA",
                        }}
                      >
              ...
              <Link
                to="/programs/multipurpose-health-worker/notices"
