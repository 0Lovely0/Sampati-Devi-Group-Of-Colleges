...
const EventsPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        ...
        const mapped: EventUI[] = mphwEvents.map((e: any) => ({
          id: e.eventId,
          title: e.title,
          desc: e.description,
        ...
        console.error("MPHW Events load error:", error);
      } finally {
        setLoading(false);
      }
    };
  ...
  if (loading) {
    return (
      <div
        className="min-h-screen flex items-center justify-center font-bold tracking-widest text-xs"
        style={{
      ...
      >
        <div className="text-center">
          ...
          <p className="text-slate-500 mt-2">
            Check back later for upcoming MPHW events.
          </p>
        </div>
      </div>
    );
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-orange-100 mt-6 max-w-xl mx-auto text-sm">
          Explore workshops, field visits, health awareness programs,
          community outreach activities, practical training sessions,
          seminars, academic programs, and Multipurpose Health Worker
          Department events.
        </p>
      </div>
          ...
          {events.map((event) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <h2
                  className="text-lg font-black text-slate-900 mt-4 leading-tight transition"
                  style={{
                    color: "#0F172A",
                  }}
                >
        ...
        >
          ...
          >
            ...
            <div className="p-8">
              ...
              <div
                className="mt-6 inline-flex items-center px-4 py-2 rounded-full text-xs font-bold"
                style={{
                  backgroundColor: MPHW_THEME.secondary,
                  color: MPHW_THEME.primary,
                }}
