...
/**
 * 🎯 FIXED: Pharmacy theme (from your department config)
 */
...
const ImageCarousel = () => {
  ...
  /**
   * Loading UI (Pharmacy theme)
   */
  if (loading) {
    return (
      <div
        className="h-[50vh] md:h-[80vh] w-full flex items-center justify-center"
        style={{ background: PHARMACY_THEME.secondary }}
      >
        <Loader text="Loading Pharmacy visuals..." />
      </div>
    );
  }
  ...
  return (
    <div className="relative w-full group">
      ...
      <button
        ...
        "
        style={{ backgroundColor: PHARMACY_THEME.primary }}
      >
        <ChevronLeft size={24} />
      </button>
