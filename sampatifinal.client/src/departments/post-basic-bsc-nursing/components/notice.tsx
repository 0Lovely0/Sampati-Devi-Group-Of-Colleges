          ...
          <div className="lg:col-span-4">
            ...
            >
              ...
              <div>
                ...
                <div className="flex items-center gap-2 text-blue-100 font-bold text-xs uppercase tracking-widest mb-6">
                  <Sparkles size={14} />
                  Real-time Updates
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="rounded-2xl bg-white/10 p-4 text-center border border-white/10">
                  ...
                  <p className="text-[9px] uppercase tracking-widest text-blue-100 mt-1">
                    Active
                  </p>
                </div>
          ...
          <div className="lg:col-span-8">
            <div className="h-[500px] bg-white p-6 sm:p-8 rounded-3xl border border-blue-100 shadow-sm flex flex-col">
              ...
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-black text-[#1E40AF]">
                  Latest Updates
                </h3>

                <span className="text-[10px] font-bold uppercase tracking-widest px-4 py-1.5 rounded-full bg-[#DBEAFE] text-[#1E40AF]">
                  Auto Scrolling
                </span>
              </div>
