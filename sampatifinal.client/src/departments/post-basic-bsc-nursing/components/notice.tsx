      ...
      <div className="w-full mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            >
              ...
              <div>
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-[12px] uppercase tracking-widest text-blue-100 font-bold">
                      Post Basic B.Sc Nursing
                    </p>
                  </div>
                </div>

                <div className="flex items-center gap-2 text-blue-100 font-bold text-lg uppercase tracking-widest mb-6">
                  <Sparkles size={14} />
                  Real-time Updates
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="rounded-2xl bg-white/10 p-4 text-center border border-white/10">
                  ...
                  <p className="text-[12px] uppercase tracking-widest text-blue-100 mt-1">
                    Active
                  </p>
                </div>
          ...
          <div className="lg:col-span-8">
            <div className="h-[500px] bg-white p-6 sm:p-8 rounded-3xl border border-blue-100 shadow-sm flex flex-col">

              <div className="flex items-center justify-between mb-6">
                <h3 className="text-2xl font-black text-[#1E40AF]">
                  Latest Updates
                </h3>

                <span className="text-[12px] font-bold uppercase tracking-widest px-4 py-1.5 rounded-full bg-[#DBEAFE] text-[#1E40AF]">
                  Auto Scrolling
                </span>
              </div>
                  ...
                  <div className="animate-[scrollTop_20s_linear_infinite] space-y-4">
                    {scrollingNotices.map((notice, index) => (
                      <div
                        ...
                        className="flex items-center gap-4 p-4 rounded-xl border border-stone-100 hover:border-[#3B82F6] hover:bg-[#DBEAFE] transition-all duration-300"
                      >
                        <span
              ...
              <Link
                to="/programs/post-basic-bsc-nursing/notices"
