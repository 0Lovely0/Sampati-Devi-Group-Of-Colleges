  ...
  useEffect(() => {
    const fetchNews = async () => {
      try {
        ...
        console.error("Failed to fetch Veterinary Pharmacist news:", error);
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <>
      <div
        ...
        style={{
          backgroundColor: "#15803D", // veterinary primary
          borderColor: "#22C55E",
        }}
      >
        {/* LEFT LABEL */}
        ...
        {/* TICKER */}
        <Link
          to="/programs/veterinary-pharmacist/news"
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to right,#15803D,transparent)",
            }}
          />
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to left,#15803D,transparent)",
            }}
          />

          {loading ? (
            <div className="h-9 flex items-center px-4 text-green-100 text-xs animate-pulse">
              Loading Veterinary updates...
            </div>
          ) : news.length > 0 ? (
            ...
            <div className="h-9 flex items-center px-4 text-green-100 text-xs italic">
              No Veterinary news available
            </div>
          )}
        </Link>
      </div>
