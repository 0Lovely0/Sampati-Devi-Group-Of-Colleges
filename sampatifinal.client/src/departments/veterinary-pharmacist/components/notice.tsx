...
const NoticeBoard: React.FC = () => {
  ...
  useEffect(() => {
    const fetchNotices = async () => {
      try {
        ...
        console.error("Veterinary notice fetch failed:", err);
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <section className="bg-[#DCFCE7] py-12">
          ...
          <div className="lg:col-span-8">
            <div className="h-[500px] bg-white p-6 sm:p-8 rounded-3xl border border-green-100 shadow-sm flex flex-col">
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="text-[10px] font-bold uppercase tracking-widest px-4 py-1.5 rounded-full bg-[#DCFCE7] text-[#15803D]">
                  Auto Scrolling
                </span>
              </div>
                  ...
                  <div className="animate-[scrollTop_20s_linear_infinite] space-y-4">
                    {scrollingNotices.map((notice, index) => (
                      <div
                        ...
                        className="flex items-center gap-4 p-4 rounded-xl border border-stone-100 hover:border-[#22C55E] hover:bg-[#DCFCE7] transition-all duration-300"
                      >
                        <span
              ...
              <Link
                to="/programs/veterinary-pharmacist/notices"
