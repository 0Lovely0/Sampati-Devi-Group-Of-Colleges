    ...
    >
      ...
      >
        ...
        <h2 className="text-3xl md:text-4xl font-black text-white mt-4">
          Veterinary Pharmacist Achievers
        </h2>
        ...
        <p className="mt-4 text-white/70 text-xs max-w-xl mx-auto">
          Celebrating the outstanding performers of Veterinary Pharmacist Department.
        </p>
      </div>
      ...
      <div className="relative w-full overflow-hidden -mt-8">
        {loading ? (
          ...
          <div className="text-center text-slate-600 text-sm py-10">
            No toppers found for Veterinary Pharmacist.
          </div>
        ) : (
            ...
            {list.map((item, index) => (
              ...
              >
                ...
                <div
                  ...
                  style={{ backgroundColor: "rgba(21, 128, 61, 0.95)" }}
                >
                  <p
      ...
      <div className="flex justify-center mt-10">
        <Link
          to="/programs/veterinary-pharmacist/toppers"
