...
//       {/* ================= SIDEBAR ================= */}
//       <aside
//         className={`fixed lg:static inset-y-0 left-0 z-30 w-72 bg-slate-900 text-white flex flex-col h-screen transition-transform duration-300 ${
//           isSidebarOpen
//             ? "translate-x-0"
...
//             <img src="/logo1.ico" className="w-8 h-8" />
...
//               className="flex items-center justify-between w-full px-4 py-2 text-xs uppercase tracking-wider text-slate-400 hover:text-white"
//             >
//               Management
//               {isManagementOpen ? (
//                 <ChevronUp size={14} />
...
//             className="w-full flex items-center justify-center gap-2 px-4 py-2 rounded-xl bg-indigo-950 hover:bg-slate-700 text-sm"
//           >
//             ← Back to Website
//           </button>
...
//             className="w-full flex items-center justify-center gap-2 px-4 py-2 rounded-xl text-red-400 hover:bg-red-500/10 text-sm"
//           >
//             <LogOut size={16} />
//             Logout
//           </button>
...
//         {/* MOBILE HEADER */}
//         <header className="lg:hidden flex items-center gap-3 bg-white px-4 py-3 shadow-sm">
