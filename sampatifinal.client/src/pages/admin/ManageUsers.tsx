...
//         newErrors.adminPassword = "Enter new password";
//         hasError = true;
...
//                     }))
//                   }
//                   className="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100"
//                 >
