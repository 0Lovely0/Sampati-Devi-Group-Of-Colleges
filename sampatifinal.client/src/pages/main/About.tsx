    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <section className="bg-white p-8 md:p-12 rounded-2xl shadow-lg mb-12">
          <h2 className="text-3xl font-bold text-blue-900 mb-6">Our Legacy & Vision</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-8">
            <div className="border-l-4 border-blue-600 pl-4">
              ...
              <p className="text-gray-600">To emerge as a center of excellence that integrates academic rigor with practical expertise, fostering graduates who are skilled and compassionate.</p>
            </div>
            <div className="border-l-4 border-green-500 pl-4">
              <h3 className="text-xl font-bold mb-2">Our Mission</h3>
              <p className="text-gray-600">Bridging the gap between academic learning and industry requirements through strong clinical partnerships and innovative teaching.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-center text-blue-900 mb-10">Our Departments</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={idx} className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 border-t-4 border-blue-900">
        ...
        <section className="bg-blue-50 p-8 md:p-12 rounded-2xl">
