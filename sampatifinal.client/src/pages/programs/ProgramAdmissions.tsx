...
export default function ProgramAdmissions() {
    ...
    <div className="min-h-screen flex items-center justify-center bg-stone-50 px-4">
      <div className="text-center max-w-md bg-white border shadow-sm rounded-2xl p-8">
        ...
        <p className="text-xs text-slate-500 mt-2 leading-relaxed">
          We are currently working on building the admissions section.
          Please check back soon for updates and application details.
        </p>
